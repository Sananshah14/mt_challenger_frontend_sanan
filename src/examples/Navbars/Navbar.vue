      ...
      >
        ...
        <ul class="navbar-nav justify-content-end">
          <li class="nav-item d-flex align-items-center">
            <button
              class="px-0 nav-link font-weight-bold text-white btn btn-link"
              @click="logout"
            >
              <i
...
export default {
  ...
  methods: {
    ...
    async logout() {
      ...
      // Send the token to the server for invalidation
      try {
        await axios.post(
      ...
      // Redirect the user back to the sign-in page after logout
